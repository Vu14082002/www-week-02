START TRANSACTION;
INSERT INTO customer (address, email, cust_name, phone)
VALUES ('123 Customer St', 'customer1@example.com', 'Customer 1', '555-1111'),
...
INSERT INTO employee (address, dob, email, full_name, phone, status)
VALUES ('123 Employee St', '1990-01-15 08:00:00', 'employee1@example.com', 'John Doe', '555-1234', 1),
...
INSERT INTO product (description, manufacturer_name, name, status, unit)
VALUES ('Product 1 Description', 'Manufacturer A', 'Product 1', 1, 'Piece'),
...
VALUES ('2023-09-22 14:30:00', 1, 1),
...
INSERT INTO order_detail (order_id, product_id, note, price, quantity)
VALUES (1, 1, 'Note 1', 10.99, 2),
       (1, 2, 'Note 2', 5.99, 3),
       (2, 3, 'Note 3', 15.99, 1),
       (3, 4, 'Note 4', 12.99, 4),
       (3, 5, 'Note 5', 8.99, 2),
...
INSERT INTO product_image (alternative, path, product_id)
VALUES ('Image 1', 'assets/img/a.jpg', 1),
       ('Image 2', 'assets/img/b.jpg', 2),
       ('Image 3', 'assets/img/bootstrap-ring.png', 3),
       ('Image 4', 'assets/img/bootstrap-template.png', 4),
       ('Image 5', 'assets/img/c.jpg', 5),
       ('Image 6', 'assets/img/d.jpg', 6),
       ('Image 7', 'assets/img/e.jpg', 7),
       ('Image 8', 'assets/img/f.jpg', 8),
       ('Image 9', 'assets/img/g.jpg', 9),
       ('Image 10', 'assets/img/h.jpg', 10),
       ('Image 11', 'assets/img/i.jpg', 11),
       ('Image 12', 'assets/img/j.jpg', 12),
       ('Image 13', 'assets/img/shopping-cart-template.png', 13);
INSERT INTO product_price (price_date_time, note, price, product_id)
VALUES ('2023-09-22 12:30:45.123456', 'Initial Price', 9.99, 1),
